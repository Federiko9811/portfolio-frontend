...
export const metadata: Metadata = {
  ...
  description:
    "Federico Raponi's personal portfolio showcasing his projects, skills, and certifications.",
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <meta
          property="og:image"
          content="https://federicoraponi.it/og-image.jpg"
        />
      </head>
      <body
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              url: "https://federicoraponi.it",
              description:
                "Federico Raponi's professional portfolio showcasing web development skills, projects, and technical expertise in software engineering.",
              sameAs: [
